...
const storyThemes = {
    walmart: {
        ...
        subtitle: "Follow DataBot as he transforms messy store data into sales insights using our 12 essential tools!",
    ...
    airline: {
        ...
        steps: {
            ...
            step12: { title: "LLMs - The AI Passenger Agent", desc: "LLMs power the virtual assistant that passengers chat with! 🧠 'My connecting flight is tight, will I make it?' The LLM checks gates, walking time, current delays, and responds instantly.", example: "Pilot asks: 'Optimal altitude for fuel efficiency on LAX→JFK given today's jet stream?' LLM: '38,000ft, saving 340 gallons vs FL350.' ✈️" }
        },
